...
<template>
  <div class="d-lg-flex flex-row">
    <div class="desktop-bg">
      <!-- Logo -->
      <header class="container py-4 ps-4">
      ...
      <!-- Hero Mobile -->
      <img class="w-100 d-block d-lg-none" src="../assets/hero-mobile.jpg" />

      <!-- Content Container-->
      <main class="d-lg-flex align-items-lg-center h-75">
        <div class="card container px-lg-5 py-5 align-items-stretch">
          <!-- Text -->
          <div
            class="d-flex flex-column align-items-center align-items-lg-start py-4"
          >
            <h1 class="card__title text-primary fw-lighter">WE'RE</h1>
            <h1 class="card__title text-danger text-center text-lg-left">
              COMING
            </h1>
            <h1 class="card__title text-danger text-center text-lg-left">
              SOON
            ...
            <h2
              class="card__subtitle text-primary fw-normal fs-6 pt-3 lh-base text-center text-lg-start"
            >
              Hello fellow shoppers! We're currently buidling our new fashion
              store. Add you email below to stay up-to-date with announcements
              and our launch deals.
            </h2>
          </div>
          <!-- Email Input -->
          <form class="card__footer my-4" @submit="handleSubmit" novalidate>
            <div
              class="input-group justify-content-center justify-content-lg-start align-items-center"
            >
              <input
                type="email"
                id="email"
              ...
              <div class="input-group-append">
                <button class="btn btn-lg shadow" type="submit">
                  <svg
                    class="mx-3 mx-lg-4 my-2"
              ...
              <div class="invalid-feedback lh-1 pt-1 ps-3" role="alert">
                Please provide a valid email
              </div>
              <div class="valid-feedback lh-1 pt-1 ps-3">Thanks!</div>
            </div>
          </form>
        </div>
      </main>
    ...
    <img
      class="w-100 d-none d-lg-block hero-desktop"
